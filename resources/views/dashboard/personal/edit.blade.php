            ...
            <div class="col-12">
                <div class="card-box">
                    ...
                    <div class="form-group px-4 pt-2">
                        ...
                        <h3 class="fs-1 d-inline-block ml-1">Editar empleado</h3>
                    </div>

                    <form class="px-4 pt-2 pb-2" action="{{ route('personal.update', $empleado->id) }}" method="post">
                        @csrf
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="nombre" name="nombre"
                                        placeholder="John" value="{{ old('nombre', $empleado->nombre) }}" >
                                    @error('nombre')
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="apellido" name="apellido"
                                        placeholder="Doe" value="{{ old('apellido', $empleado->apellido) }}" >
                                    @error('apellido')
                                    <span class="error text-danger">* {{ $message }}</span>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="direccion" name="direccion"
                                        placeholder="Address" value="{{ old('direccion', $empleado->direccion) }}">
                                    @error('direccion')
                                    <span class="error text-danger">* {{ $message }}</span>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="number" min="0" class="form-control" id="ci" name="ci"
                                        placeholder="1234567" value="{{ old('ci', $empleado->ci) }}">
                                    @error('ci')
                                    <span class="error text-danger">* {{ $message }}</span>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="number" min="0" class="form-control" id="telefono" name="telefono"
                                        placeholder="77664412" value="{{ old('telefono', $empleado->telefono) }}">
                                    @error('telefono')
                                    <span class="error text-danger">* {{ $message }}</span>
                                    @enderror
                                </div>
                        ...
                        <div class="row">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="custom-control custom-radio">
                                        <input type="radio" value="F" name="genero" class="custom-control-input"
                                            id="femenino"
                                            {{ old('genero', $empleado->genero) === 'F' ? 'checked' : '' }}
                                            >
                                    ...
                                    <div class="custom-control custom-radio mt-1">
                                        <input type="radio" value="M" name="genero" class="custom-control-input"
                                            id="masculino"
                                            {{ old('genero', $empleado->genero) === 'M' ? 'checked' : '' }}
                                            >
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="puesto_id" class="control-label">Puesto o Cargo</label>
                                    <select class="form-control" name="puesto_id" id="puesto_id">
                                        <option value="">Seleccionar</option>
                                        @foreach ($puestos as $puesto)
                                            <option value="{{ $puesto->id }}"
                                             @if ($puesto->id == old('puesto_id', $empleado->puesto_id))
                                                selected
                                            @endif
